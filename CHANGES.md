...
* Add Go module support ([#143](https://github.com/peterargue/go-twitter/pull/143))

## 11/2018

* Add `DirectMessageService` support for the new Twitter Direct Message Events [API](https://developer.twitter.com/en/docs/direct-messages/api-features) ([#125](https://github.com/peterargue/go-twitter/pull/125))
